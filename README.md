...
| Module | Purpose |
|--------|---------|
| `01-provisioning-engine/` | Day 1 base platform layouts, custom binary segregation, and dynamic replica rebuilding |
...
| `05-high-availability-efm/` | Clustering & failsafe VIP routing, rolling EFM upgrades with interface checks |
| `06-backup-recovery/` | Pre-flight backup verification, pgBackRest validation, and prepatch snapshot automation |
| `07-performance-tuning/` | Kernel HugePages, THP disable, memory optimization for EPAS |
